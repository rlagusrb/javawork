...
public class ServerProgram {
	/*
	 * 현제 구동중인 서버가 있으면 클라이언트는 그서버로 요청을 보낼수 있음 => 응답결과가 돌아옴
	 ...
	 * 소켓 프로그래밍
	 * - TCP: 데이터를 정확하고 안정적으로 전달 가능(신뢰성). 느림
	 ...
	 * -서버,클라이언트 1:1소켓통신
	 * -데이터를 교환하기 전에 서버, 클라이언트가 연결되어 있어야 됨
	 * 
	 * Socket
	...
	public static void main(String[] args) {
		...
		try {
			...
			//4)연결 요청이 들어오면 수락 후 해당 클라이언트와 통신할 수 있는 서버특 소켓 객체 생성
